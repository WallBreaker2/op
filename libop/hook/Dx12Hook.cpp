...
typedef HRESULT(WINAPI *D3D12PresentPointer)(IDXGISwapChain *swapChain, UINT syncInterval, UINT flags);
...
HRESULT Dx12Hook::CaptureFrames(HWND windowHandleToCapture, std::wstring_view folderToSaveFrames, int maxFrames) {
...
void Dx12Hook::CaptureFrame(IDXGISwapChain *swapChain) {
    HRESULT hr;
